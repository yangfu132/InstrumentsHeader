...
@class NSLock, NSMenuItem, NSString, XRAutomaticSpinTracer, XRDockMenuViewController, XRInstrumentsServices;
...
- (void)_checkIfNeedToShowSymbolicationModernizationWindow;
