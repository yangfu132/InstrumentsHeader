...
#ifndef InstrumentsPlugIn_framework_h
#define InstrumentsPlugIn_framework_h
...
// UUID: EC9A24D2-59C6-330B-86C5-4FE67A085C7D
//
//                           Arch: x86_64
...
- (id)description;
- (BOOL)evaluateWithDevice:(id)arg1 variables:(id)arg2;
- (id)initWithCapability:(id)arg1 minVersion:(long long)arg2 errorString:(id)arg3;
...
@interface PFTInstrumentType : NSObject <NSCoding>
{
    ...
    NSMutableArray *_supportedServices;
    BOOL _simulatorRequiresService;
    NSMutableArray *_requiredCapabilities;
    NSMutableDictionary *_recordingAssertions;
...
- (void)_parseRecordingAssertions:(id)arg1;
- (void)_parseLegacyRecordingOptions;
- (void)_parseRecordingOptionPlatforms:(id)arg1;
- (void)_parseSupportedServices:(id)arg1;
- (void)_parseLegacySupportedServices;
- (void)_parseSupportedPlatforms:(id)arg1;
- (void)_parseLegacySupportedPlatforms;
- (void)_parseRequiredCapabilities:(id)arg1;
...
- (void)_addEnabledDeviceSubgroup:(id)arg1 withTitle:(id)arg2;
...
@interface _XRAnalysisCoreSpaceDirectory : NSObject <XRAnalysisCoreSpaceDirectory>
{
    ...
    XRIntKeyedDictionary *_coresByRunNumber;
    XRIntKeyedDictionary *_errorRespondersByRunNumber;
...
@property(readonly, nonatomic) __weak id <XRErrorResponder> errorResponder; // @synthesize errorResponder=_errorResponder;
- (void).cxx_destruct;
- (void)dealloc;
- (id)spaceName;
- (BOOL)isSerial;
...
- (id)initWithSourceURL:(id)arg1 errorResponder:(id)arg2;
...
+ (void)initialize;
@property BOOL connectionTimedOut; // @synthesize connectionTimedOut=_connectionTimedOut;
...
@interface XRCapabilityMapping : NSObject
{
    NSString *_mnemonic;
    NSString *_capabilityIdentifier;
}

+ (id)capabilityMapForIdentifier:(id)arg1 mnemonic:(id)arg2;
@property(readonly, nonatomic) NSString *capabilityIdentifier; // @synthesize capabilityIdentifier=_capabilityIdentifier;
@property(readonly, nonatomic) NSString *mnemonic; // @synthesize mnemonic=_mnemonic;
- (void).cxx_destruct;
...
+ (BOOL)supportsSecureCoding;
@property(readonly, copy, nonatomic) NSImage *icon; // @synthesize icon=_icon;
@property(readonly, copy, nonatomic) NSColor *highlightTextColor; // @synthesize highlightTextColor=_highlightTextColor;
@property(readonly, copy, nonatomic) NSColor *highlightColor; // @synthesize highlightColor=_highlightColor;
...
- (void)encodeWithCoder:(id)arg1;
- (id)initWithCoder:(id)arg1;
- (id)initWithColor:(id)arg1 textColor:(id)arg2 highlightColor:(id)arg3 highlightTextColor:(id)arg4 icon:(id)arg5 priority:(long long)arg6;
...
- (id)iconForType:(unsigned short)arg1 value:(id)arg2;
- (id)iconForType:(unsigned short)arg1;
...
@interface XRUniqueErrorAccumulator : NSObject <XRErrorResponder>
{
    NSMutableOrderedSet *_uniqueErrors;
    id <XRErrorResponder> _nextResponder;
    long long _signature;
}

- (void).cxx_destruct;
- (BOOL)getErrorHierarchyAsXML:(id *)arg1 afterSignature:(long long *)arg2;
...
@interface XRUniqueErrorWrapper : NSObject
{
    NSError *_error;
    NSMutableOrderedSet *_subErrorWrappers;
}

@property(readonly, nonatomic) NSMutableOrderedSet *subErrorWrappers; // @synthesize subErrorWrappers=_subErrorWrappers;
...
@interface NSXMLElement (XRUniqueErrorAccumulator)
- (id)errorAccumulatorSubErrors;
- (id)errorAccumulatorLocalizedDescription;
@end

#endif /* InstrumentsPlugIn_framework_h */
