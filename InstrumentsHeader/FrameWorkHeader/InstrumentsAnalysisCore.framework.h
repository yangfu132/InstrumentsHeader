//
//  InstrumentsAnalysisCore.framework.h
//  MacDemo
//
...
#ifndef InstrumentsAnalysisCore_framework_h
#define InstrumentsAnalysisCore_framework_h
//2016-11-25 15:41:10.819 class-dump[2854:1004578] Warning: Parsing instance variable type failed, _runningBulkLoaderCount
//2016-11-25 15:41:10.829 class-dump[2854:1004578] Warning: Parsing instance variable type failed, _managedRetainCount
//
...
struct XRActiveBlackboardFacts;

struct XRAnalysisCoreAbstractRowArrayCursor {
...
struct XRAnalysisCoreEngineeringType {
    ...
    id _field4;
    id _field5;
    union XRStoredValue _field6;
    struct function<bool (const void *, const void *)> _field7;
    struct function<bool (const void *, const void *)> _field8;
};
...
struct XRAnalysisCoreWriteCursor {
    ...
    struct _XRStorageManagerExternalAccessPack *_field10;
    vector_5b13af2a *_field11;
    id _field12;
    struct _XRStorageManagerCursor _field13;
};
...
struct XRBinderEngine {
    ...
    struct unordered_set<void *, std::__1::hash<void *>, std::__1::equal_to<void *>, std::__1::allocator<void *>> _clipsHeldObjects;
};
...
struct XRCLIPS {
    ...
    CDStruct_a3227609 _field8;
    id _field9;
    id _field10;
    id _field11;
    unsigned long long _field12;
    struct unordered_set<void *, std::__1::hash<void *>, std::__1::equal_to<void *>, std::__1::allocator<void *>> _field13;
};
...
struct XRCLIPSBlackboardEngine {
    ...
    id _threadNamingOracleToken;
    XRAnalysisCoreValue *_reusableValue1;
    ...
    struct unique_ptr<XRActiveBlackboardFacts, std::__1::default_delete<XRActiveBlackboardFacts>> _activeFacts;
    struct deftemplate *_nowTemplate;
    unsigned long long _now;
    void *_currentNowFact;
    void *_modelerModule;
    void *_recorderModule;
    void *_blackboardModule;
    void *_inputModule;
    unsigned int _narrativeLogTableID;
    unsigned char _narrativeLogClockColID;
    unsigned char _narrativeLogSigColID;
    unsigned long long _loggingFlags;
    _Bool _haltModeling;
    _Bool _panicStop;
    unsigned int _integerArrayType;
};
...
struct XRIntegerUniquer {
    ...
    int _field9;
    int _field10;
    struct LookupTable _field11;
    struct HashTableProperties _field12;
};
...
struct XRInternalObjectRegistry {
    ...
    struct vector<externalAddressHashNode *, std::__1::allocator<externalAddressHashNode *>> _typedArrayNodesByIID;
...
struct _MergingCursor {
    ...
    XRFrameActivity *_activity;
    char *_shouldYield;
    long long _rowCount;
    long long _rowsDrained;
    unsigned long long _timeStarted;
    unsigned long long _timeYielding;
...
struct unique_ptr<XRActiveBlackboardFacts, std::__1::default_delete<XRActiveBlackboardFacts>> {
    struct __compressed_pair<XRActiveBlackboardFacts *, std::__1::default_delete<XRActiveBlackboardFacts>> {
        struct XRActiveBlackboardFacts *__first_;
    } __ptr_;
};

struct unique_ptr<XRAnalysisCoreAbstractRowArrayCursor, std::__1::default_delete<XRAnalysisCoreAbstractRowArrayCursor>> {
    struct __compressed_pair<XRAnalysisCoreAbstractRowArrayCursor *, std::__1::default_delete<XRAnalysisCoreAbstractRowArrayCursor>> {
        struct XRAnalysisCoreAbstractRowArrayCursor *_field1;
    } _field1;
};

struct unique_ptr<XRAnalysisCoreTableBindings, std::__1::default_delete<XRAnalysisCoreTableBindings>> {
    struct __compressed_pair<XRAnalysisCoreTableBindings *, std::__1::default_delete<XRAnalysisCoreTableBindings>> {
        struct XRAnalysisCoreTableBindings *__first_;
    } __ptr_;
};
...
struct unique_ptr<std::__1::__hash_node<void *, void *>*[], std::__1::__bucket_list_deallocator<std::__1::allocator<std::__1::__hash_node<void *, void *>*>>> {
    struct __compressed_pair<std::__1::__hash_node<void *, void *>**, std::__1::__bucket_list_deallocator<std::__1::allocator<std::__1::__hash_node<void *, void *>*>>> {
        struct __hash_node<void *, void *> **__first_;
        struct __bucket_list_deallocator<std::__1::allocator<std::__1::__hash_node<void *, void *>*>> {
            struct __compressed_pair<unsigned long, std::__1::allocator<std::__1::__hash_node<void *, void *>*>> {
                unsigned long long __first_;
            } __data_;
        } __second_;
    } __ptr_;
...
struct unique_ptr<std::__1::vector<unsigned int, std::__1::allocator<unsigned int>>, std::__1::default_delete<std::__1::vector<unsigned int, std::__1::allocator<unsigned int>>>> {
    struct __compressed_pair<std::__1::vector<unsigned int, std::__1::allocator<unsigned int>>*, std::__1::default_delete<std::__1::vector<unsigned int, std::__1::allocator<unsigned int>>>> {
        struct vector<unsigned int, std::__1::allocator<unsigned int>> *__first_;
    } __ptr_;
};
...
struct unordered_set<void *, std::__1::hash<void *>, std::__1::equal_to<void *>, std::__1::allocator<void *>> {
    struct __hash_table<void *, std::__1::hash<void *>, std::__1::equal_to<void *>, std::__1::allocator<void *>> {
        struct unique_ptr<std::__1::__hash_node<void *, void *>*[], std::__1::__bucket_list_deallocator<std::__1::allocator<std::__1::__hash_node<void *, void *>*>>> __bucket_list_;
        struct __compressed_pair<std::__1::__hash_node_base<std::__1::__hash_node<void *, void *>*>, std::__1::allocator<std::__1::__hash_node<void *, void *>>> {
            struct __hash_node_base<std::__1::__hash_node<void *, void *>*> {
                struct __hash_node<void *, void *> *__next_;
            } __first_;
        } __p1_;
...
struct vector<InputBinding, std::__1::allocator<InputBinding>> {
    struct InputBinding *__begin_;
    struct InputBinding *__end_;
    struct __compressed_pair<InputBinding *, std::__1::allocator<InputBinding>> {
        struct InputBinding *__first_;
    } __end_cap_;
};
...
typedef struct unique_ptr<XRAnalysisCoreAbstractRowArrayCursor, std::__1::default_delete<XRAnalysisCoreAbstractRowArrayCursor>> {
    struct __compressed_pair<XRAnalysisCoreAbstractRowArrayCursor *, std::__1::default_delete<XRAnalysisCoreAbstractRowArrayCursor>> {
        struct XRAnalysisCoreAbstractRowArrayCursor *_field1;
    } _field1;
} unique_ptr_f6d9901d;
...
// UUID: A271755D-2E5C-3C97-85FF-3FBBC2004B0F
//
//                           Arch: x86_64
...
- (BOOL)getOutput:(id *)arg1;
- (void)setOutput:(XRAnalysisCoreValue *)arg1;
- (BOOL)getArgumentAsValue:(id *)arg1 atIndex:(unsigned int)arg2;
- (void)setArgumentIndex:(unsigned int)arg1 value:(XRAnalysisCoreValue *)arg2;
- (id <XRAnalysisCoreValueFactory>)valueFactory;
@end

@protocol XRAnalysisCoreModeler <NSObject>
- (void)populateSpeculationTables:(const struct XRAnalysisCoreTableBindings *)arg1 parameters:(XRAnalysisCoreModelingParameters *)arg2;
- (void)populateOutputTables:(const struct XRAnalysisCoreTableBindings *)arg1 usingObserverations:(struct XRAnalysisCoreReadCursor *)arg2 parameters:(XRAnalysisCoreModelingParameters *)arg3;
- (void)resetModelerStateWithTables:(id <XRIntKeyedDictionaryImmutable>)arg1 parameters:(XRAnalysisCoreModelingParameters *)arg2;

@optional
- (void)debuggingAsynchronousPanicStop;
...
- (void)modelingActivityCompletedWithParameters:(XRAnalysisCoreModelingParameters *)arg1;
@end
...
- (unsigned long long)rowInDimension:(unsigned char)arg1 closestToTime:(unsigned long long)arg2 intersects:(char *)arg3;
...
@protocol XRAnalysisCoreQueryFrameAccessor <XRAnalysisCoreReadOnly, XRAnalysisCoreQueryFrameAccessorBase>
@end
...
@protocol XRAnalysisCoreRegistry <XRAnalysisCoreValueFactory>
...
- (union XRStoredThreadName)storedThreadName:(NSString *)arg1 thread:(unsigned int)arg2;
...
@protocol XRAnalysisCoreValueFactory <NSObject>
- (long long)getNextUniqueIdentifier;
- (BOOL)getCPCallstack:(id *)arg1 process:(XRAnalysisCoreValue *)arg2 pc:(unsigned long long)arg3 frames:(struct XRUInt64Array)arg4 extraRegisters:(struct XRUInt64Array)arg5;
- (BOOL)getTimeInterval:(id *)arg1 start:(unsigned long long)arg2 duration:(unsigned long long)arg3;
- (BOOL)getThread:(id *)arg1 tid:(unsigned long long)arg2 process:(XRAnalysisCoreValue *)arg3;
- (BOOL)getNarrative:(id *)arg1 format:(NSString *)arg2 args:(NSArray *)arg3;
- (BOOL)getThreadName:(id *)arg1 name:(NSString *)arg2 thread:(XRAnalysisCoreValue *)arg3;
- (BOOL)getProcessValue:(id *)arg1 pid:(int)arg2 sessionUUID:(NSString *)arg3;
- (BOOL)getBacktraceFragment:(struct XRBacktraceFragment *)arg1 process:(XRAnalysisCoreValue *)arg2 frames:(struct XRUInt64Array)arg3;
- (BOOL)getBacktraceValue:(id *)arg1 fragments:(const struct XRBacktraceFragment *)arg2 count:(unsigned int)arg3;
- (BOOL)getValue:(id *)arg1 implementation:(XRAnalysisCoreImplValue *)arg2 engineeringType:(unsigned short)arg3;
@end
...
@interface XRAnalysisCoreActivityManager : XRFrameActivityManager
{
...
__attribute__((visibility("hidden")))
@interface XRAnalysisCoreQueryFrameSession : NSObject <XRAnalysisCoreQueryFrameAccessor>
{
    XRFrameActivity *_control;
    XRAnalysisCoreBindingHemisphere *_binding;
}
...
- (void)randomAccessForTableID:(unsigned int)arg1 block:(CDUnknownBlockType)arg2;
- (id)init;
- (id)initWithFrameActivity:(id)arg1 binding:(id)arg2;
...
- (void)setArgumentIndex:(unsigned int)arg1 value:(id)arg2;
- (id)init;
...
__attribute__((visibility("hidden")))
@interface XRAnalysisCoreXMLColumnSetter : XRAnalysisCoreXMLParserContext
{
    XRAnalysisCoreValue *_value;
    unsigned char _colID;
    XRAnalysisCoreXMLUniversalValueSetter *_valueSetter;
    unsigned short _elementEtype;
    NSDictionary *_elementAttrs;
    XRAnalysisCoreTableSchema *_schema;
    struct XRAnalysisCoreWriteCursor *_cursor;
}

@property(nonatomic) struct XRAnalysisCoreWriteCursor *cursor; // @synthesize cursor=_cursor;
...
@property(readonly, copy) NSString *debugDescription;
- (void)modelingActivityCompletedWithParameters:(id)arg1;
- (void)populateSpeculationTables:(const struct XRAnalysisCoreTableBindings *)arg1 parameters:(id)arg2;
- (void)populateOutputTables:(const struct XRAnalysisCoreTableBindings *)arg1 usingObserverations:(struct XRAnalysisCoreReadCursor *)arg2 parameters:(id)arg3;
- (void)resetModelerStateWithTables:(id)arg1 parameters:(id)arg2;
- (void)addTable:(id)arg1 withID:(unsigned int)arg2;
- (id)init;
- (id)initWithModelingRulesURL:(id)arg1 extraRulesURLs:(struct NSArray *)arg2 modelerClassName:(id)arg3 registry:(id)arg4 configURL:(id)arg5 knownKnowledgeURLs:(id)arg6 knownKnowledgeTemplatesURLs:(id)arg7 knownSchemata:(id)arg8 errorResponder:(id)arg9;
...
- (void).cxx_destruct;
@property(readonly, nonatomic, getter=isInstantiated) BOOL instantiated;
...
+ (void)registerStorageCapabilities:(id)arg1;
...
- (void).cxx_destruct;
- (void)dealloc;
- (void)query:(id)arg1 tableID:(unsigned int)arg2 context:(id)arg3 activity:(id)arg4 handler:(id)arg5;
...
- (void).cxx_destruct;
@property(copy, nonatomic) NSArray *typedArray;
...
- (const union XRImplementedValue *)value;
...
__attribute__((visibility("hidden")))
@interface XRAnalysisCoreXMLParser : NSObject
{
...
@property(readonly, nonatomic) id <XRErrorResponder> errorResponder; // @synthesize errorResponder=_errorResponder;
- (void).cxx_destruct;
- (void)endOfStream;
- (void)addParsableXMLData:(id)arg1;
- (void)_handleFatalError:(id)arg1;
- (void)_popContext;
- (void)_pushContext:(id)arg1;
- (void)dealloc;
- (id)initWithInitialContext:(id)arg1 errorResponder:(id)arg2;

@end

__attribute__((visibility("hidden")))
@interface XRAnalysisCoreXMLParserContext : NSObject
{
    XRAnalysisCoreXMLParser *_parser;
    int _elementDepth;
}

- (void).cxx_destruct;
- (void)foundCharacters:(id)arg1;
- (void)startElement:(id)arg1 attributes:(id)arg2;
- (void)endElement:(id)arg1;
- (void)willPop;
- (void)wasPushed;
- (void)pushContext:(id)arg1;
- (void)abortWithMissingAttribute:(id)arg1 element:(id)arg2;
- (void)abortWithInvalidElement:(id)arg1;
- (void)abortWithFatalError:(id)arg1;
- (void)_addToParser:(id)arg1;

@end

__attribute__((visibility("hidden")))
@interface XRAnalysisCoreXMLAccumulatingContext : XRAnalysisCoreXMLParserContext
{
    NSMutableString *_accumulator;
    XREngineeringNumberFormatter *_engNumberFormatter;
...
- (void)wasPushed;
- (void)foundCharacters:(id)arg1;
- (BOOL)parseCDATAIntoImpl:(id)arg1;
@property(readonly, nonatomic) NSString *accumulatedCDATA;
- (void)clearAccumulatedCDATA;
- (id)initWithAttributes:(id)arg1;

@end

__attribute__((visibility("hidden")))
@interface XRAnalysisCoreXMLTableLoadDoc : XRAnalysisCoreXMLParserContext
{
    XRAnalysisCoreXMLTableLoader *_tableLoader;
    XRAnalysisCoreBindingHemisphere *_binding;
}

- (void).cxx_destruct;
- (void)startElement:(id)arg1 attributes:(id)arg2;
- (id)initWithBindingHemisphere:(id)arg1 activity:(id)arg2;
...
- (id).cxx_construct;
- (void).cxx_destruct;
- (unsigned long long)_rowInDimension:(unsigned char)arg1 closestToTime:(unsigned long long)arg2 intersects:(char *)arg3 store:(id)arg4;
...
{
    // Error parsing type: Aq, name: _runningBulkLoaderCount
    BOOL _engaged;
    BOOL _sealed;
    BOOL _breeched;
    unsigned long long _targetEventHorizon;
    ...
    id <XRErrorResponder> _errorResponder;
    id <XRErrorResponder> _standardErrorResponder;
}

@property(retain, nonatomic) id <XRErrorResponder> standardErrorResponder; // @synthesize standardErrorResponder=_standardErrorResponder;
@property(retain, nonatomic) id <XRErrorResponder> errorResponder; // @synthesize errorResponder=_errorResponder;
...
@property(nonatomic) unsigned long long loggingFlags; // @synthesize loggingFlags=_loggingFlags;
@property(nonatomic) BOOL breeched; // @synthesize breeched=_breeched;
...
- (void).cxx_destruct;
- (long long)runningBulkLoaderCount;
- (void)decrementRunningBulkLoaderCount;
- (void)incrementRunningBulkLoaderCount;
...
__attribute__((visibility("hidden")))
@interface XRAnalysisCoreXMLTableLoader : XRAnalysisCoreXMLParserContext
{
    XRAnalysisCoreBindingHemisphere *_bindingHemisphere;
    XRFrameActivity *_activity;
    XRAnalysisCoreXMLRowAdder *_rowAdder;
    XRAnalysisCoreXMLSchemaParser *_schemaParser;
    XRAnalysisCoreXMLAttributeParser *_attributeParser;
    struct unique_ptr<XRAnalysisCoreTableBindings, std::__1::default_delete<XRAnalysisCoreTableBindings>> _activeBindings;
}
...
__attribute__((visibility("hidden")))
@interface XRAnalysisCoreXMLSchemaParser : XRAnalysisCoreXMLParserContext
{
    NSMutableString *_schemaName;
}

@property(retain, nonatomic) NSMutableString *schemaName; // @synthesize schemaName=_schemaName;
- (void).cxx_destruct;
- (void)foundCharacters:(id)arg1;
- (id)init;
...
__attribute__((visibility("hidden")))
@interface XRAnalysisCoreXMLAttributeParser : XRAnalysisCoreXMLParserContext
{
    NSMutableString *_workingKey;
    NSMutableString *_workingValue;
...
__attribute__((visibility("hidden")))
@interface XRAnalysisCoreXMLRowAdder : XRAnalysisCoreXMLParserContext
{
    XRAnalysisCoreXMLColumnSetter *_colSetter;
    struct XRAnalysisCoreWriteCursor *_cursor;
}

@property(nonatomic) struct XRAnalysisCoreWriteCursor *cursor; // @synthesize cursor=_cursor;
- (void).cxx_destruct;
@property(retain, nonatomic) XRAnalysisCoreTableSchema *schema;
- (void)startElement:(id)arg1 attributes:(id)arg2;
- (id)init;
...
__attribute__((visibility("hidden")))
@interface XRAnalysisCoreTickModeler : NSObject <XRAnalysisCoreModeler>
{
    unsigned long long _clock;
    unsigned long long _period;
    unsigned long long _events;
    unsigned int _tableID;
    unsigned char _tickCol;
}
...
__attribute__((visibility("hidden")))
@interface XRAnalysisCoreModelingParameters : NSObject
{
    NSDictionary *_bindingParameters;
    unsigned long long _leadingEventHorizon;
    unsigned long long _trailingEventHorizon;
    id <XRAnalysisCoreReadOnly> _core;
    unsigned long long _loggingFlags;
}

@property(readonly, nonatomic) unsigned long long loggingFlags; // @synthesize loggingFlags=_loggingFlags;
@property(readonly, nonatomic) id <XRAnalysisCoreReadOnly> core; // @synthesize core=_core;
@property(nonatomic) unsigned long long trailingEventHorizon; // @synthesize trailingEventHorizon=_trailingEventHorizon;
@property(nonatomic) unsigned long long leadingEventHorizon; // @synthesize leadingEventHorizon=_leadingEventHorizon;
@property(readonly, nonatomic) NSDictionary *bindingParameters; // @synthesize bindingParameters=_bindingParameters;
- (void).cxx_destruct;
- (id)initWithReadOnlyCore:(id)arg1 parameters:(id)arg2 loggingFlags:(unsigned long long)arg3;
...
- (BOOL)getTimeIntervalDetails:(unsigned long long *)arg1 duration:(unsigned long long *)arg2;
- (BOOL)getThreadNameDetails:(id *)arg1 thread:(id *)arg2;
- (BOOL)getProcessDetails:(int *)arg1 session:(id *)arg2;
- (BOOL)getThreadDetails:(id *)arg1 tid:(unsigned long long *)arg2;
...
- (void)enumerateDTACBundleContentWithOptions:(unsigned long long)arg1 subpath:(id)arg2 block:(CDUnknownBlockType)arg3;
- (void)_scanURLForCoreExtensions:(id)arg1 block:(CDUnknownBlockType)arg2;

@end

__attribute__((visibility("hidden")))
@interface XRAnalysisCoreQueryManager : XRAnalysisCoreActivityManager <XRAnalysisCoreQueryFrameAccessorBase>
{
}
...
@interface XRManagedEvent : NSObject <NSCopying>
{
    ...
    // Error parsing type: Ai, name: _managedRetainCount
}
...
@interface XRAnalysisCoreTableSchema : NSObject
{
    ...
    unsigned char _primaryDurationColumnID;
    unsigned char _topologyTypeID;
    NSString *_name;
}

+ (BOOL)validateSchemaXMLDocument:(id)arg1 errorResponder:(id)arg2;
+ (BOOL)validateXMLFile:(id)arg1 errorResponder:(id)arg2;
+ (id)schemaFromXMLElement:(id)arg1;
@property(readonly) unsigned char topologyTypeID; // @synthesize topologyTypeID=_topologyTypeID;
...
- (void)tearDown;
- (int)_handleMinorFrameWithDeadline:(unsigned long long)arg1;
- (id)validateWithOptions:(unsigned long long)arg1;
- (id)seal;
- (id)disengage;
- (id)engage;
- (void)setTargetEventHorizon:(unsigned long long)arg1;
...
@interface XRAnalysisCoreModelingHemisphere : NSObject
{
    ...
    XRAnalysisCoreUtilityModelerFactory *_utilityModelerFactory;
...
__attribute__((visibility("hidden")))
@interface XRAnalysisCoreValidator : NSObject
{
    XRAnalysisCoreContext *_context;
    XRAnalysisCoreBindingHemisphere *_binding;
    XRAnalysisCoreModelingHemisphere *_modeling;
}

- (void).cxx_destruct;
- (void)validateWithOptions:(unsigned long long)arg1;
- (id)initWithContext:(id)arg1 bindingHemisphere:(id)arg2 modelingHemisphere:(id)arg3;

@end

__attribute__((visibility("hidden")))
@interface XRAnalysisCoreUtilityModelerFactory : NSObject <XRAnalysisCoreModelerFactory>
{
}
...
- (void)executeQuery:(id)arg1 tableID:(unsigned int)arg2 context:(id)arg3 activity:(id)arg4 handler:(id)arg5 wgStart:(unsigned short)arg6 wgCount:(unsigned int)arg7 locals:(id)arg8;
...
@interface XRAnalysisCoreModelerInstance : NSObject
{
    ...
    unsigned long long _modelingHorizon;
    NSString *_modelerClassName;
    id <XRAnalysisCoreModeler> _modeler;
    XRAnalysisCoreModelingParameters *_parameters;
    struct XRTimeRange _currentInputRange;
}

@property(readonly, nonatomic) XRAnalysisCoreModelingParameters *parameters; // @synthesize parameters=_parameters;
@property(nonatomic) struct XRTimeRange currentInputRange; // @synthesize currentInputRange=_currentInputRange;
@property(nonatomic) unsigned long long modelingHorizon; // @synthesize modelingHorizon=_modelingHorizon;
@property(retain, nonatomic) id <XRAnalysisCoreModeler> modeler; // @synthesize modeler=_modeler;
@property(readonly, nonatomic) NSString *modelerClassName; // @synthesize modelerClassName=_modelerClassName;
- (void).cxx_destruct;
- (void)finishedModeling;
- (void)addTable:(id)arg1 tableID:(unsigned int)arg2;
@property(readonly, nonatomic) id <XRIntKeyedDictionaryImmutable> tablesByID;
- (id)init;
- (id)initWithClassName:(id)arg1 parameters:(id)arg2;
...
- (id)debuggingSwapLogString:(id)arg1;
- (id)debuggingDumpWorkingMemoryForContext:(id)arg1;
- (void)validateAbsenceOfErrorSpew;
- (void)validateBindingRules:(id)arg1 errorResponder:(id)arg2;
- (id)coreSubpath;
- (id)createFunctionInvocation;
- (BOOL)invokeOracleFunction:(id)arg1 invocation:(id)arg2;
- (id)oracleFunctionTokenWithName:(id)arg1;
...
- (void)announceUsedStorageCapabilities;
- (void)seal;
...
- (void)randomAccessForTableID:(unsigned int)arg1 activity:(id)arg2 block:(CDUnknownBlockType)arg3;
- (void)performOnPivotArray:(id)arg1 operation:(unsigned long long)arg2 control:(id)arg3;
- (void)accessPivotArray:(id)arg1 block:(CDUnknownBlockType)arg2;
- (void)readRowsInArray:(id)arg1 startingAt:(unsigned int)arg2 activity:(id)arg3 block:(CDUnknownBlockType)arg4;
- (id)selectRowsWithQuery:(id)arg1 tableID:(unsigned int)arg2 sortDescriptors:(id)arg3;
- (id)selectRowsWithQuery:(id)arg1 tableID:(unsigned int)arg2;
...
__attribute__((visibility("hidden")))
@interface XRAnalysisCoreXMLValueSetter : XRAnalysisCoreXMLAccumulatingContext
{
    id *_targetValue;
    unsigned short _etype;
    id <XRAnalysisCoreValueFactory> _factory;
}

@property(retain, nonatomic) id <XRAnalysisCoreValueFactory> factory; // @synthesize factory=_factory;
@property(nonatomic) unsigned short etype; // @synthesize etype=_etype;
- (void).cxx_destruct;
- (id)initWithValueTarget:(id *)arg1 attributes:(id)arg2;

@end

__attribute__((visibility("hidden")))
@interface XRAnalysisCoreXMLUniversalValueSetter : XRAnalysisCoreXMLValueSetter
{
    NSDictionary *_valueSetterSubs;
    NSMutableArray *_valueAccum;
    XRAnalysisCoreValue *_workingValue;
    XRAnalysisCoreXMLUniversalValueSetter *__workingValueSetter;
    NSString *_threadName;
    XRAnalysisCoreXMLFragmentContext *_fragmentContext;
    NSMutableData *_workingBTFragments;
    XRAnalysisCoreValue *_cpCallStackAddrs;
    XRAnalysisCoreValue *_cpCallStackPC;
    XRAnalysisCoreValue *_cpCallStackProcess;
    XRAnalysisCoreValue *_cpCallStackExtraRegs;
}
...
- (void)endElement:(id)arg1;
- (void)startElement:(id)arg1 attributes:(id)arg2;
- (void)_startParsingTypedArray;
- (id)_workingValueSetter;
- (BOOL)_parsingTypedArray;
...
__attribute__((visibility("hidden")))
@interface XRAnalysisCoreXMLFragmentContext : XRAnalysisCoreXMLParserContext
{
    XRAnalysisCoreValue *_value;
    XRAnalysisCoreXMLUniversalValueSetter *_setter;
    XRAnalysisCoreValue *_process;
    XRAnalysisCoreValue *_frames;
    id <XRAnalysisCoreValueFactory> _factory;
}

@property(retain, nonatomic) id <XRAnalysisCoreValueFactory> factory; // @synthesize factory=_factory;
- (void).cxx_destruct;
- (BOOL)getFragment:(struct XRBacktraceFragment *)arg1;
- (void)wasPushed;
- (void)endElement:(id)arg1;
- (void)startElement:(id)arg1 attributes:(id)arg2;
...
@interface XRCLIPSModelerFactory : NSObject <XRAnalysisCoreModelerFactory>
{
    ...
    NSMutableDictionary *_extraRulesURLByClassName;
    NSSet *_knowledgeTemplatesURLs;
    NSSet *_knowledgeRulesURLs;
    NSArray *_knownSchemata;
}
...
- (id)knownSchemata;
- (void)instanceModelersInSolution:(id)arg1;
- (void)instanceModelersInSolution:(id)arg1 errorResponder:(id)arg2;
- (BOOL)isCLIPSModeler:(id)arg1;
- (void)registerKnowledgeTemplatesURL:(id)arg1;
- (void)registerKnowledgeRulesURL:(id)arg1;
- (void)registerExtraRulesURL:(id)arg1 modelerClassName:(id)arg2;
- (void)registerRulesURL:(id)arg1 modelerClassName:(id)arg2;
- (void)updateKnownSchemata:(id)arg1;
- (id)initWithPathManager:(id)arg1 coreSubpath:(id)arg2 registery:(id)arg3 errorResponder:(id)arg4;
...
__attribute__((visibility("hidden")))
@interface XRAnalysisCoreThreadNameModeler : NSObject <XRAnalysisCoreModeler>
{
    struct unordered_set<unsigned long long, std::__1::hash<unsigned long long>, std::__1::equal_to<unsigned long long>, std::__1::allocator<unsigned long long>> _resolvedThreadSignatures;
    struct vector<InputBinding, std::__1::allocator<InputBinding>> _inputBindings;
    struct {
        unsigned char timeCol;
        unsigned char threadCol;
        unsigned char nameCol;
    } _columns;
    unsigned long long _inputCount;
    unsigned int _outputTableID;
    BOOL _boundToOutput;
    NSMutableAttributedString *_log;
}
...
- (unsigned int)substitutionIdentifierForObject:(id)arg1;
- (id)fieldWithName:(id)arg1;
@property(readonly, nonatomic) XREventDescriptor *persistantEventDescriptor;
...
{
    struct vector<_XRStorageManagerDirectAddress, std::__1::allocator<_XRStorageManagerDirectAddress>> _newContents;
    unsigned int _tableID;
    XRAnalysisCore *_core;
    XRAnalysisCoreTableQuery *_filter;
...
- (id).cxx_construct;
- (void).cxx_destruct;
- (unique_ptr_f6d9901d)_readCursorWithStore:(id)arg1 start:(unsigned long long)arg2;
- (BOOL)_needsRefresh;
- (id)refresh;
- (void)readRowsStartingAt:(unsigned int)arg1 block:(CDUnknownBlockType)arg2;
- (void)_purgeSpeculativeContent;
- (BOOL)_stableBetweenMinorFrames;
...
{
    XRAnalysisCoreValue *_value;
    XRAnalysisCoreChooseAnyFunction *_parent;
}
...
@interface XRAnalysisCoreObjectRegistry : NSObject <XRAnalysisCoreRegistry>
{
    ...
    long long _nextUniqueIdentifier;
    XRAnalysisCoreObjectRegistryTOC *_toc;
    id _weakProxy;
    struct XRIntegerUniquer *_remappedTypedArrayUniquer;
    struct unique_ptr<std::__1::vector<unsigned int, std::__1::allocator<unsigned int>>, std::__1::default_delete<std::__1::vector<unsigned int, std::__1::allocator<unsigned int>>>> _typedArrayIIDMapping;
    NSURL *_remappedTypedArrayUniquerURL;
    id <XRErrorResponder> _errorResponder;
}
...
- (id).cxx_construct;
- (void).cxx_destruct;
- (void)_writeETypeMapping;
- (long long)getNextUniqueIdentifier;
- (BOOL)getCPCallstack:(id *)arg1 process:(id)arg2 pc:(unsigned long long)arg3 frames:(struct XRUInt64Array)arg4 extraRegisters:(struct XRUInt64Array)arg5;
- (BOOL)getBacktraceFragment:(struct XRBacktraceFragment *)arg1 process:(id)arg2 frames:(struct XRUInt64Array)arg3;
- (BOOL)getNarrative:(id *)arg1 format:(id)arg2 args:(id)arg3;
- (BOOL)getProcessValue:(id *)arg1 pid:(int)arg2 sessionUUID:(id)arg3;
- (BOOL)getBacktraceValue:(id *)arg1 fragments:(const struct XRBacktraceFragment *)arg2 count:(unsigned int)arg3;
- (BOOL)getTimeInterval:(id *)arg1 start:(unsigned long long)arg2 duration:(unsigned long long)arg3;
- (BOOL)getThread:(id *)arg1 tid:(unsigned long long)arg2 process:(id)arg3;
- (BOOL)getThreadName:(id *)arg1 name:(id)arg2 thread:(id)arg3;
- (BOOL)getValue:(id *)arg1 implementation:(id)arg2 engineeringType:(unsigned short)arg3;
- (BOOL)getExistingStoredValue:(union XRStoredValue *)arg1 fromImplValue:(id)arg2;
- (union XRStoredThreadName)storedThreadName:(id)arg1 thread:(unsigned int)arg2;
- (union XRStoredValue)storedThreadState:(unsigned int)arg1;
- (union XRStoredValue)storedProcess:(int)arg1 deviceSession:(unsigned int)arg2;
- (struct XRStoredUInt64Array)storedBacktrace:(const struct XRBacktraceFragment *)arg1 count:(unsigned int)arg2;
...
- (void)coreSubpathWillChange;
- (void)coreSubpathDidChange:(id)arg1;
- (id)initWithPathManager:(id)arg1 coreSubpath:(id)arg2 errorResponder:(id)arg3;
...
@interface XRAnalysisCoreObjectRegistryTOC : NSObject <NSSecureCoding>
{
    ...
    long long _nextUniqueIdentifier;
    NSString *_etypeMapComponent;
}

+ (BOOL)supportsSecureCoding;
+ (id)tocWithMissingArchiveAtUniquingURL:(id)arg1;
+ (long long)version;
@property(copy, nonatomic) NSString *etypeMapComponent; // @synthesize etypeMapComponent=_etypeMapComponent;
@property(nonatomic) long long nextUniqueIdentifier; // @synthesize nextUniqueIdentifier=_nextUniqueIdentifier;
- (void).cxx_destruct;
- (id)urlForETypeMapping:(id)arg1;
...
- (id)initWithCoder:(id)arg1;
- (id)init;
- (id)initWithArrayComponent:(id)arg1 typedArrayComponent:(id)arg2 stringComponent:(id)arg3 nextUniqueIdentifier:(long long)arg4 etypeMapComponent:(id)arg5;
...
@interface NSDictionary (CLIPS)
- (void)addParametersToCLIPS:(void *)arg1 module:(id)arg2;
@end

@interface NSError (XRAnalysisCore)
+ (id)analysisCoreFailedToCreateValueError:(unsigned short)arg1;
+ (id)analysisCoreFatalModelerError:(id)arg1;
+ (id)analysisCoreCLIPSWerrorChannelError:(id)arg1;
+ (id)analysisCoreCLIPSRuleError:(id)arg1;
+ (id)analysisCoreXMLParsingErrorWithCode:(unsigned long long)arg1 problem:(id)arg2;
+ (id)analysisCoreFailureFindingAggregateFunction:(id)arg1;
+ (id)analysisCoreDTACComponentInvalidError:(id)arg1;
+ (id)analysisCoreErrorWithCode:(unsigned long long)arg1;
@end
...
#endif /* InstrumentsAnalysisCore_framework_h */
